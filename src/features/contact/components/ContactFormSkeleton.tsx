export default function ContactFormSkeleton() {
  return (
    <div className="w-full max-w-2xl mx-auto bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 shadow-xs rounded-lg">
      <div className="p-4">
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <div className="h-9 bg-gray-100 dark:bg-gray-800 rounded animate-pulse"></div>
            </div>
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                <div className="h-4 w-4 bg-gray-200 dark:bg-gray-700 rounded animate-pulse"></div>
      ...
      {/* Footer */}
      <div className="bg-gray-50 dark:bg-gray-900/50 p-4 rounded-b-lg">
        <div className="h-12 bg-gray-200 dark:bg-gray-700 rounded animate-pulse mb-3"></div>
