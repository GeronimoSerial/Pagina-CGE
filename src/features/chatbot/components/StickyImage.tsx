    ...
    <div className="sticky top-24 self-start">
      <div className="relative">
        <a
          ...
          className="block group focus:outline-hidden focus:ring-2 focus:ring-[#3D8B37] focus:ring-offset-2 rounded-xl"
          aria-label="Acceder al Chat Normativo CGE"
        >
          <div className="cursor-pointer transition-all duration-500 hover:scale-105 shadow-xl hover:shadow-[#3D8B37]/30 transform hover:-translate-y-2 rounded-2xl p-1 bg-linear-to-r from-[#3D8B37]/15 via-[#3D8B37]/20 to-[#3D8B37]/40">
        ...
        <div className="absolute -bottom-4 left-0 right-0 flex justify-center z-20">
          <span className="text-sm text-[#3D8B37] font-medium italic bg-white/95 backdrop-blur-xs px-4 py-2 rounded-full shadow-md whitespace-nowrap border border-[#3D8B37]/20">
