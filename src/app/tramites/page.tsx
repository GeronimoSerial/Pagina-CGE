...
import TramitesGridClient from "./TramitesComponent";
    ...
    <main className="bg-gray-50 min-h-screen">
      ...
      <div className="bg-gradient-to-r from-[#2D6A27] to-[#3D8B37] text-white">
        <div className="container mx-auto px-4 md:px-6 py-16">
          <div className="max-w-3xl">
            <h1 className="text-4xl font-bold mb-4">Trámites y Gestiones</h1>
            <p className="text-lg opacity-90">
              Portal centralizado de trámites del Consejo General de Educación.
      ...
      <section className="py-12 md:py-16">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <TramitesGridClient tramite={tramite} categorias={categorias} />
        </div>
      </section>
