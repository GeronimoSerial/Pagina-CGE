      ...
      <div className="max-w-4xl mx-auto">
        <section className="prose prose-lg max-w-none">
          ...
          <p className="mb-6">
            ...
            pública relacionada con la educación en la provincia de Corrientes.
          ...
          <p className="mb-6">
            El CGE se compromete a mantener actualizada y precisa la información
            publicada. Sin embargo, no se garantiza la ausencia total de errores
            involuntarios o desactualización temporal. En caso de duda, se
            recomienda contactar al organismo de forma oficial.
          </p>
          <h2 className="text-2xl font-semibold mb-4 text-gray-800">
            5. Enlaces externos
          </h2>
          <p className="mb-6">
            El sitio puede contener enlaces a páginas externas que pertenecen a
            otros organismos o entidades. El CGE no se responsabiliza por el
          ...
          <p className="mb-6">
            Toda controversia derivada de la interpretación o aplicación de los
            presentes términos será sometida a la jurisdicción de los tribunales
            ordinarios de la Provincia de Corrientes.
          </p>
        </section>
      </div>
    </PageLayout>
