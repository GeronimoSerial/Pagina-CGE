    ...
    <div className="min-h-screen bg-slate-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg shadow-sm overflow-hidden border-l-2 border-slate-200">
            <div className="px-6 py-4">
              <h2 className="text-lg font-semibold text-slate-900">Miércoles</h2>
            </div>
            <div className="p-6 space-y-4">
              <div className="flex gap-4">
                <div className="flex-shrink-0 w-32">
          ...
          <div className="bg-white rounded-lg shadow-sm overflow-hidden border-l-2 border-slate-200">
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="flex gap-4">
                ...
                <div className="flex-1">
                  <p className="text-slate-700 font-medium">
                    Reunión con supervisores y directivos seleccionados en la Facultad de
                    Derecho y Ciencias Sociales (UNNE)
                  </p>
                </div>
              </div>
              <div className="flex gap-4">
