      ...
      <div className="max-w-4xl mx-auto">
        <section className="prose prose-lg max-w-none">
          ...
          <p className="mb-6">
            ...
            garantizar la accesibilidad de su sitio web para todas las personas,
            independientemente de sus capacidades o discapacidades. Trabajamos
            continuamente para asegurar que todos los usuarios puedan acceder a
            la información y servicios de manera efectiva y eficiente.
          </p>
          ...
          <ul className="list-disc pl-6 mb-6">
            <li>
              ...
              para navegar secuencialmente por todos los elementos interactivos
            </li>
            <li>
              Usar{' '}
              <kbd className="px-2 py-1 bg-gray-100 rounded border border-gray-300">
          ...
          <ul className="list-disc pl-6 mb-6">
            ...
            <li>Pruebas con usuarios que utilizan tecnologías de asistencia</li>
            <li>
