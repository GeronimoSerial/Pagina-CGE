...
export async function GET(
  ...
  try {
    ...
    const { type, page, pageSize, limit, categoria } = validateParameters(searchParams);
    
    // 2. Construir URL de Directus
    const directusUrl = buildDirectusUrl(type, page, pageSize, limit, categoria);
    ...
    const apiResponse: UnifiedNewsResponse = {
      ...
      meta: {
        ...
        ...(type === 'featured' && { total_featured: directusData.meta.total_count }),
      },
    };
